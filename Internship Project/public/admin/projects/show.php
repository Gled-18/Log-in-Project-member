<?php   
  ...
  if(is_post_request()){
    redirect_to(url_for('/admin/projects/add_user.php'));
  }
?>
...
<div>
    <div>
      ...
      <a href="<?php echo url_for('/admin/projects/index.php?id='. $_SESSION['user_id']); ?>">&laquo; Back My Projects</a>
    </div>
    <div>
      ...
      <table>
        ...
        <?php $user = find_user_by_id($member['user_id'])?>
          <tr>
            ...
            <?php if($role === "admin") {?>
            <td><a href="<?php echo url_for('/admin/projects/remove_user.php?id=' . $member['ID']); ?>" class="action">Delete</a></td>
            <?php } ?>
          </tr>
        <?php } ?>
      </table>
    ...
    <div>
    <?php if($role === "admin"){ ?>
    <form action="<?php echo url_for('/admin/projects/show.php?id='. $project['ID']) ?>" method="post">
      <div>
