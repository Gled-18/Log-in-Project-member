<?php
  ...
  if(is_post_request()){
    ...
    $user = get_user_by_username($username);
      ...
      if($result === true){
        redirect_to(url_for('/admin/projects/show.php?id=' . $_SESSION['project_id']));
      }
...
<div>
  <a href="<?php echo url_for('/admin/projects/show.php?id='. $_SESSION['project_id']) ?>">Back</a>
  <div>
    <h1>Add member to project</h1>
    <?php echo display_errors($my_errors); ?>
    <form action="<?php echo url_for('/admin/projects/add_user.php?id=' . $member['project_id']); ?>" method="post">
