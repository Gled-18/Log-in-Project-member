...
<div>
  <div>
    ...
    <div>
      ...
      <a href="<?php echo url_for('/admin/projects/new.php'); ?>">&laquo; Create New Project</a>
    </div>
  </div>
<table>
        <tr>
        ...
        <?php while($my_project = mysqli_fetch_assoc($my_project_set)) { ?>
          ...
          <tr>
            ...
            <td><a href="<?php echo url_for('/admin/projects/show.php?id=' .  $project['ID']); ?>" class="action">View</a></td>
            <td><a href="<?php echo url_for('/admin/projects/edit.php?id=' .  $my_project['project_id']); ?>" class="action">Edit</a></td>
            <?php if($role === "admin") {?>
            <td><a href="<?php echo url_for('/admin/projects/delete.php?id=' . $my_project['project_id']); ?>" class="action">Delete</a></td>
            <?php } ?>
          </tr>
          <?php } ?>
      </table>
